...
// Gradient .ffx templates extracted from Google AEUX (Apache-2.0)
// https://github.com/google/AEUX - see NOTICE in README.
// Binary RIFX presets with text placeholder lines that get patched
// with gradient stop values before applyPreset().

var SVGSPLIT = SVGSPLIT || {};

SVGSPLIT.gradTemplates = {
